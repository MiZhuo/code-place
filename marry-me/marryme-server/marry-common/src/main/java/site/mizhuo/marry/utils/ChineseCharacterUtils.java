...
public class ChineseCharacterUtils {
    ...
    private static final int UNI_CODE_LENGTH_UP = 128;

    private static final int INDEX = 23;
    /**
     * 存放国标一级汉字不同读音的起始区位码
     */
    private static final int[] SEC_POS_VALUE_LIST = { 1601, 1637, 1833, 2078, 2274, 2302, 2433, 2594, 2787, 3106, 3212, 3472, 3635,
            3722, 3730, 3858, 4027, 4086, 4390, 4558, 4684, 4925, 5249, 5600 };

    /**
     * 存放国标一级汉字不同读音的起始区位码对应读音
     */
    private static final char[] FIRST_LETTER = { 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'J', 'K', 'L', 'M', 'N', 'O', 'P', 'Q',
            'R', 'S', 'T', 'W', 'X', 'Y', 'Z' };
    ...
    public static Character getFirstLetter(char ch) {
        ...
        // 非汉字
        if (uniCode[0] < UNI_CODE_LENGTH_UP && uniCode[0] > 0) {
            return null;
        } else {
